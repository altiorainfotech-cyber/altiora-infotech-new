...
const [core, ...satellites] = adServices;
...
const DECOR_TAGS: Record<number, string> = { 2: "LIVE", 4: "98.2%" };
...
export function PaidAdsServicesGrid() {
  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="paid-ads-services-heading">
      <Container>
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h2 id="paid-ads-services-heading" className="mt-3 text-3xl font-black tracking-tight text-ink sm:text-4xl">
              Our Paid Advertising Services
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-3 text-sm sm:text-base leading-relaxed text-muted">
              Six connected disciplines, one campaign engine — every decision runs back through a single advertising
              strategy.
            </p>
          </Reveal>
        </div>
        ...
        <div className="mt-12 lg:hidden">
          <div className="relative rounded-2xl border border-ink/8 bg-white p-5">
            <div className="mb-4 flex items-center justify-between font-mono text-[10px] font-bold uppercase tracking-[0.15em] text-ink/40">
              <span>Advertising Intelligence System</span>
