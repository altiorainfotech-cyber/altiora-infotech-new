...
import { AeoGeoCoverageGrid } from "./AeoGeoCoverageGrid";
...
export function AeoGeoOverview() {
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="aeo-geo-overview-heading">
      ...
      <Container>
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-start">
          <div className="lg:col-span-5">
            ...
            <Reveal delay={0.05}>
              <h2 id="aeo-geo-overview-heading" className="mt-4 text-3xl font-black tracking-tight text-ink sm:text-4xl leading-[1.15]">
            ...
            <Reveal delay={0.15}>
              <div className="mt-6 relative overflow-hidden rounded-2xl border border-ink/8 shadow-lg">
                <div className="relative aspect-[16/10] w-full">
                  <Image
                    src={overviewImage}
                    alt="AI-powered search and answer engine visibility"
                    fill
                  ...
                  <div className="absolute bottom-3 left-3 flex items-center gap-2 rounded-lg border border-ink/10 bg-white/90 px-3 py-1.5 text-xs font-bold text-ink shadow-sm backdrop-blur-md">
                    ...
                    <span>AI Visibility Tracked</span>
                  </div>
                </div>
              </div>
            </Reveal>
