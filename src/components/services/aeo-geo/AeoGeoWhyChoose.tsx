...
import { whyChooseAeoGeo, whyChooseAeoGeoConclusion } from "@/data/aeoGeo";
import { ShieldCheck, Sparkles } from "lucide-react";

export function AeoGeoWhyChoose() {
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="aeo-geo-why-choose-heading">
      ...
      <Container>
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h2 id="aeo-geo-why-choose-heading" className="mt-3 text-3xl font-black tracking-tight text-ink sm:text-4xl">
