  ...
  return (
    <section ref={containerRef} className="relative overflow-hidden bg-transparent py-14 sm:py-24" aria-labelledby="aeo-process-heading">
      ...
      <Container>
        ...
        <div className="mt-14 rounded-3xl border border-ink/10 bg-gradient-to-br from-slate-900 via-purple-950 to-ink p-6 sm:p-12 text-white shadow-2xl relative overflow-hidden">
          <div className="relative mb-8 hidden lg:block">
            <div className="h-1.5 w-full rounded-full bg-white/10" />
            <motion.div
              className="absolute top-0 left-0 h-1.5 rounded-full bg-gradient-to-r from-purple-500 via-pink-400 to-gold-400 shadow-[0_0_15px_rgba(139,92,246,0.6)]"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
            {aeoGeoProcess.map((step, idx) => {
              ...
              return (
                <motion.div
                  key={step.number}
                  className="relative flex flex-col justify-between rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-md transition-all duration-300 hover:border-purple-400/50"
                  style={{
                ...
                >
                  <div>
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-xs font-black text-purple-400">{step.number}</span>
                      <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-purple-900 text-white border border-white/20">
