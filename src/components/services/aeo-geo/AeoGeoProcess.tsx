...
export function AeoGeoProcess() {
  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="aeo-geo-process-heading">
        ...
        <div className="max-w-2xl">
          <Reveal>
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-50/80 px-3.5 py-1 text-xs font-extrabold text-blue-800">
              ...
              <span>How We Build AI Visibility</span>
            </div>
          </Reveal>
          <Reveal delay={0.05}>
            <h2 id="aeo-geo-process-heading" className="mt-3 text-3xl font-black tracking-tight text-ink sm:text-4xl">
              Our AEO &amp; GEO Process
            </h2>
          </Reveal>
        </div>
