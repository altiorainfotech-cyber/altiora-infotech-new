...
import { graphicDesignProcess } from "@/data/graphicDesign";
...
export function GraphicDesignProcess() {
  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="graphic-process-heading">
      ...
      <Container>
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h2 id="graphic-process-heading" className="mt-3 text-3xl font-black tracking-tight text-ink sm:text-4xl">
        ...
        <ol ref={trackRef} className="relative mt-16 grid grid-cols-2 gap-x-6 gap-y-12 sm:grid-cols-3 lg:grid-cols-6">
          ...
          {graphicDesignProcess.map((step, idx) => {
