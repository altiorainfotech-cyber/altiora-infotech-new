...
import { graphicDesignServices } from "@/data/graphicDesign";
...
const [core, ...satellites] = graphicDesignServices;
...
const DECOR_TAGS: Record<number, string> = { 0: "LIVE", 3: "PRINT-READY" };
...
export function GraphicDesignServicesGrid() {
  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="graphic-services-heading">
      <Container>
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h2 id="graphic-services-heading" className="mt-3 text-3xl font-black tracking-tight text-ink sm:text-4xl">
              Our Graphic Design Services
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-3 text-sm sm:text-base leading-relaxed text-muted">
              Complete creative solutions designed to make your brand look professional, consistent, and memorable.
            </p>
          </Reveal>
        </div>
