...
export default function GraphicDesignBackground() {
  ...
  useEffect(() => {
    ...
    // Ecosystem group: floating creative "design chips" — flat panels representing design assets
    ...
    // Floating flat design-chip panels
    const nodeGeo = new THREE.BoxGeometry(0.34, 0.24, 0.04);
