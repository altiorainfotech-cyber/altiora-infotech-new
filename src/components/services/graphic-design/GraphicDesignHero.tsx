...
import { GraphicDesignHeroVisualClient } from "./GraphicDesignHeroVisualClient";
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-7">
            ...
            <Reveal delay={0.2}>
              <div className="mt-6 flex flex-wrap items-center gap-y-2 gap-x-6 text-xs font-bold text-ink/80">
                <div className="flex items-center gap-2">
                  ...
                  <span>Strategic Creative Design</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <Reveal delay={0.26}>
              <div className="mt-8">
                <Button href={graphicDesignHero.cta.href} className="px-7 py-3.5 text-sm font-bold shadow-lg shadow-blue-600/20">
                  {graphicDesignHero.cta.label}
                </Button>
              </div>
            </Reveal>
          </div>
            ...
            <Reveal delay={0.2}>
              ...
              >
                ...
                <div className="absolute top-4 left-4 z-20 flex items-center gap-2 rounded-xl border border-white/80 bg-white/90 px-3.5 py-1.5 text-[11px] font-extrabold text-ink shadow-lg backdrop-blur-md">
                  ...
                  <span>Brand Assets, Always Consistent</span>
                </div>
