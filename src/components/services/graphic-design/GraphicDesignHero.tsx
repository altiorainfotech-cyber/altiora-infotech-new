...
import { ArrowRight, Sparkles, Palette, Activity } from "lucide-react";
import { Container } from "@/components/ui/Container";
import { Reveal } from "@/components/ui/Reveal";
import { graphicDesignHero } from "@/data/graphicDesign";
import { GraphicDesignHeroVisual } from "./GraphicDesignHeroVisual";
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 space-y-6 text-left">
            <Reveal>
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-white/80 px-4 py-1.5 text-xs font-extrabold text-blue-800 shadow-sm backdrop-blur-md">
                ...
                <span>{graphicDesignHero.eyebrow}</span>
                <span className="text-gold-500 font-black">|</span>
                <span className="text-blue-900 font-mono">DESIGN SUITE v4.2</span>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.15}>
              <div className="pt-2 flex flex-wrap items-center gap-4">
                <Link
                  href={graphicDesignHero.cta.href}
                ...
                >
                  <span>{graphicDesignHero.cta.label}</span>
                ...
                <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl border border-ink/8 bg-white/80 shadow-sm backdrop-blur-md">
                  ...
                  <span className="text-xs font-mono font-bold text-ink/80">Pixel-Perfect Vector Assets</span>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="pt-6 grid grid-cols-3 gap-4 border-t border-ink/8">
                <div>
                  ...
                  <div className="text-xs font-medium text-muted">Brands Designed</div>
                </div>
                <div>
                  <div className="text-2xl font-black text-ink">100%</div>
                  <div className="text-xs font-medium text-muted">Vector &amp; Source Files</div>
                </div>
                <div>
                  <div className="text-2xl font-black text-ink">4.9/5</div>
                  <div className="text-xs font-medium text-muted">Client Rating</div>
                </div>
              </div>
            </Reveal>
          </div>
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative">
            <div className="relative mx-auto max-w-[480px] rounded-3xl border border-white/80 bg-gradient-to-br from-white via-slate-50 to-blue-50/40 p-4 shadow-2xl backdrop-blur-xl">
              <div className="absolute top-4 left-4 z-20 flex items-center gap-2 rounded-full border border-blue-200 bg-white/90 px-3 py-1 text-[11px] font-mono font-bold text-blue-900 shadow-sm">
                ...
                <span>REAL-TIME VECTOR CANVAS</span>
              </div>
              <div className="relative aspect-square w-full">
                <GraphicDesignHeroVisual />
              </div>
              <div className="mt-3 flex items-center justify-between border-t border-slate-100 pt-3 px-2 text-[11px] font-mono font-bold text-blue-900">
                <span className="flex items-center gap-1">
                  ...
                  <span>CREATIVE SYSTEM READY</span>
                </span>
                <span className="text-blue-600">PRODUCTION ACTIVE</span>
              </div>
            </div>
          </div>
        </div>
