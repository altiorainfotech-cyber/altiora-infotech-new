...
export default function GraphicDesignHeroVisual() {
  ...
  useEffect(() => {
    ...
    // Design-chip nodes orbiting the brand mark with connecting lines
    const nodeGeo = new THREE.BoxGeometry(0.3, 0.2, 0.04);
