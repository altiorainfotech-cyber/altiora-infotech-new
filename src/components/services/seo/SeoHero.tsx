...
import { SeoHeroVisualClient } from "./SeoHeroVisualClient";
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-7">
            ...
            <Reveal delay={0.2}>
              <div className="mt-6 flex flex-wrap items-center gap-y-2 gap-x-6 text-xs font-bold text-ink/80">
                <div className="flex items-center gap-2">
                  ...
                  <span>Sustainable Organic Growth</span>
                </div>
                <div className="flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-gold-500" />
                  <span>Built for Google &amp; AI Search</span>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.26}>
              <div className="mt-8">
                <Button href={seoHero.cta.href} className="px-7 py-3.5 text-sm font-bold shadow-lg shadow-blue-600/20">
                  {seoHero.cta.label}
                </Button>
              </div>
            </Reveal>
