...
export default function SeoBackground() {
  ...
  useEffect(() => {
    ...
    // Ecosystem group: ascending "ranking" bars/rings representing search position climb
    ...
    // Concentric "search results" rings
    ...
    // Ascending nodes — represent climbing search rankings
    ...
    const animate = () => {
      ...
      if (!prefersReducedMotion) {
        ...
        nodes.forEach((node) => {
          ...
          const climb = (Math.sin(t * 0.5 + node.offset) + 1) / 2; // 0..1 gentle rise/fall
