...
export function BrandingCTA() {
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="branding-cta-heading">
          ...
          >
            ...
            <div className="relative -m-6 overflow-hidden rounded-2xl sm:-m-8">
              ...
              <div className="relative z-10 p-8 text-center sm:p-16">
                ...
                <div className="mx-auto mt-4 max-w-xl space-y-3 text-sm sm:text-base font-medium leading-relaxed text-muted text-balance">
                  <p>{brandingCta.p1}</p>
                  <p>{brandingCta.p2}</p>
                </div>
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                  ...
                  >
                    {brandingCta.secondaryCta.label}
                  </Button>
                </div>
              </div>
