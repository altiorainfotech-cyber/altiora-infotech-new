...
export default function MobileAppHeroVisual() {
  ...
  useEffect(() => {
    ...
    // Central "MOBILE APP NODE" core mesh
    ...
    // Orbiting App Nodes (iOS Native, Android Native, Flutter/React Native, Cloud API, Analytics)
    const nodeTypes = [
      { name: "iOS Swift", color: 0x3b82f6, radius: 2.8, speed: 0.5, size: 0.22 },
      { name: "Android Kotlin", color: 0x10b981, radius: 3.4, speed: -0.4, size: 0.18 },
      { name: "Cross-Platform", color: 0xd3ac3c, radius: 2.2, speed: 0.7, size: 0.24 },
      { name: "Cloud Sync", color: 0x6366f1, radius: 3.8, speed: -0.3, size: 0.25 },
      { name: "Push & Analytics", color: 0xf59e0b, radius: 4.4, speed: 0.25, size: 0.28 },
    ];
    ...
    ringRadii.forEach((r, idx) => {
      ...
      const mat = new THREE.MeshStandardMaterial({
        ...
        emissive: idx % 2 === 0 ? 0x1d4ed8 : 0xc9a227,
