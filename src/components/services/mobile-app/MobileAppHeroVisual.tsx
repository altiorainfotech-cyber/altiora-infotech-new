...
export default function MobileAppHeroVisual() {
  ...
  useEffect(() => {
    ...
    // Central "device" core — rounded phone-shaped block
    ...
    const coreGeo = new THREE.BoxGeometry(0.55, 1.05, 0.12);
    ...
    // App-screen chip nodes orbiting the device with connecting lines
    const nodeGeo = new THREE.BoxGeometry(0.2, 0.36, 0.03);
