...
export default function MobileAppBackground() {
  ...
  useEffect(() => {
    ...
    // Ecosystem group: floating "app screen" panels representing modular UI blocks
    ...
    // Floating rounded "app screen" chips (portrait aspect)
    const nodeGeo = new THREE.BoxGeometry(0.22, 0.4, 0.03);
