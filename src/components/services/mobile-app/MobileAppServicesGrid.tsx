...
const [core, ...satellites] = mobileAppServices;
...
const DECOR_TAGS: Record<number, string> = { 1: "LIVE", 3: "99.2%" };
...
export function MobileAppServicesGrid() {
  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="mobileapp-services-heading">
      <Container>
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h2 id="mobileapp-services-heading" className="mt-3 text-3xl font-black tracking-tight text-ink sm:text-4xl">
              Our Mobile App Development Services
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-3 text-sm sm:text-base leading-relaxed text-muted">
              End-to-end mobile app development designed to turn your idea into a scalable, market-ready product.
            </p>
          </Reveal>
        </div>
