...
export default function SocialMediaHeroVisual() {
  ...
  useEffect(() => {
    ...
    const pointLightPink = new THREE.PointLight(0xec4899, 6, 25);
    pointLightPink.position.set(6, 4, 6);
    ...
    // Central "SOCIAL ENGAGEMENT" core node
    ...
    // Orbiting Social Nodes (Instagram Reels, TikTok Viral, LinkedIn B2B, Community, Analytics)
    const nodeTypes = [
      { name: "Instagram", color: 0xec4899, radius: 2.8, speed: 0.5, size: 0.22 },
      { name: "TikTok", color: 0x8b5cf6, radius: 3.4, speed: -0.4, size: 0.18 },
      { name: "LinkedIn", color: 0x3b82f6, radius: 2.2, speed: 0.7, size: 0.24 },
      { name: "Community", color: 0x10b981, radius: 3.8, speed: -0.3, size: 0.25 },
      { name: "Viral Growth", color: 0xd3ac3c, radius: 4.4, speed: 0.25, size: 0.28 },
    ];
    ...
    ringRadii.forEach((r, idx) => {
      ...
      const mat = new THREE.MeshStandardMaterial({
        color: idx % 2 === 0 ? 0xec4899 : 0xd3ac3c,
        emissive: idx % 2 === 0 ? 0xdb2777 : 0xc9a227,
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      const col = colorPick > 0.6 ? cPink : colorPick > 0.3 ? cGold : cPurple;
