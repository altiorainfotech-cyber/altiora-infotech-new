...
import { Share2, Sparkles, Activity, Flame } from "lucide-react";
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative">
            <Reveal delay={0.2}>
              ...
              >
                ...
                {/* 3D Interactive WebGL Social Media Node */}
                <SocialMediaHeroVisualClient />

                {/* LIVE VIRAL TELEMETRY BADGE */}
                ...
                <div className="absolute bottom-4 right-4 z-20 flex items-center gap-3 rounded-2xl border border-gold-400/40 bg-white/95 p-3 text-xs font-black text-ink shadow-xl backdrop-blur-md">
                  <div className="flex flex-col">
                    <span className="text-[9px] uppercase font-mono tracking-wider text-gold-700">Engagement Rate</span>
                  ...
                  <div className="relative h-7 w-16 overflow-hidden rounded bg-gold-50/50 p-0.5 border border-gold-300/30">
                    <svg className="h-full w-full overflow-visible" viewBox="0 0 60 24">
                      <defs>
                        <linearGradient id="socialRoiGrad" x1="0" y1="0" x2="0" y2="1">
                      ...
                      <path
                        ...
                        strokeLinecap="round"
                      />
                      <circle cx="60" cy="1" r="2.5" fill="#f59e0b" className="animate-ping" />
                    </svg>
                  </div>
                </div>
            ...
            <Reveal delay={0.2}>
              <div className="mt-6 flex flex-wrap items-center gap-y-2 gap-x-6 text-xs font-bold text-ink/80">
                <div className="flex items-center gap-2">
                  ...
                  <span>Viral Short-Form &amp; Reels</span>
                </div>
                <div className="flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-gold-500" />
                  <span>Community &amp; Brand Authority</span>
                </div>
              </div>
            </Reveal>
