...
import { ArrowRight, Sparkles, Heart, Users, Activity } from "lucide-react";
import { Container } from "@/components/ui/Container";
import { Reveal } from "@/components/ui/Reveal";
import { influencerHero } from "@/data/influencerUgc";
import { InfluencerHeroVisual } from "./InfluencerHeroVisual";
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 space-y-6 text-left">
            ...
            <Reveal delay={0.15}>
              <div className="pt-2 flex flex-wrap items-center gap-4">
                <Link
                  href={influencerHero.cta.href}
                  className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 via-blue-700 to-blue-900 px-7 py-3.5 text-sm font-black text-white shadow-xl shadow-blue-600/25 transition-all hover:scale-105 hover:shadow-blue-600/40"
                >
                  <span>{influencerHero.cta.label}</span>
                ...
                <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl border border-ink/8 bg-white/80 shadow-sm backdrop-blur-md">
                  ...
                  <span className="text-xs font-mono font-bold text-ink/80">98.4% Creator Retention</span>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="pt-6 grid grid-cols-3 gap-4 border-t border-ink/8">
                <div>
                  <div className="text-2xl font-black text-blue-700">500+</div>
                  <div className="text-xs font-medium text-muted">Vetted Creators</div>
                </div>
                <div>
                  <div className="text-2xl font-black text-gold-600">4.8x</div>
                  <div className="text-xs font-medium text-muted">Avg ROAS Boost</div>
                </div>
                <div>
                  <div className="text-2xl font-black text-ink">10M+</div>
                  <div className="text-xs font-medium text-muted">UGC Views</div>
                </div>
              </div>
            </Reveal>
          </div>
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative">
            <div className="relative mx-auto max-w-[480px] rounded-3xl border border-blue-200/60 bg-gradient-to-b from-white via-blue-50/40 to-slate-50 p-4 shadow-2xl backdrop-blur-xl">
              <div className="absolute top-4 left-4 z-20 flex items-center gap-2 rounded-full border border-blue-200 bg-white/90 px-3 py-1 text-[11px] font-mono font-bold text-blue-900 shadow-sm">
                ...
                <span>REAL-TIME VIRALITY STREAM</span>
              </div>
              <div className="relative aspect-square w-full">
                <InfluencerHeroVisual />
              </div>
              <div className="mt-3 flex items-center justify-between border-t border-blue-100 pt-3 px-2 text-[11px] font-mono font-bold text-blue-900">
                <span className="flex items-center gap-1">
                  ...
                  <span>5.2M AUDIENCE IMPRESSIONS</span>
                </span>
                <span className="text-gold-600">VIRAL PIPELINE ACTIVE</span>
              </div>
            </div>
          </div>
        </div>
