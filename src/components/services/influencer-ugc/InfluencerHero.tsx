...
import { InfluencerHeroVisualClient } from "./InfluencerHeroVisualClient";
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-7">
            ...
            <Reveal delay={0.2}>
              <div className="mt-6 flex flex-wrap items-center gap-y-2 gap-x-6 text-xs font-bold text-ink/80">
                <div className="flex items-center gap-2">
                  ...
                  <span>Creator-Led Growth</span>
                </div>
                <div className="flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-gold-500" />
                  <span>Authentic UGC Content</span>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.26}>
              <div className="mt-8">
                <Button href={influencerHero.cta.href} className="px-7 py-3.5 text-sm font-bold shadow-lg shadow-blue-600/20">
                  {influencerHero.cta.label}
                </Button>
              </div>
            </Reveal>
          </div>
