...
import { influencerServices } from "@/data/influencerUgc";
...
const [core, ...satellites] = influencerServices;
...
const DECOR_TAGS: Record<number, string> = { 2: "LIVE", 3: "VETTED" };
...
export function InfluencerServicesGrid() {
  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="influencer-services-heading">
      <Container>
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h2 id="influencer-services-heading" className="mt-3 text-3xl font-black tracking-tight text-ink sm:text-4xl">
              Our Influencer &amp; UGC Services
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-3 text-sm sm:text-base leading-relaxed text-muted">
              A complete creator marketing system designed to connect your brand with the right audiences.
            </p>
          </Reveal>
        </div>
        ...
        <div className="mt-14 hidden lg:block">
          <Reveal delay={0.1}>
            <div className="relative mx-auto aspect-square w-full max-w-[720px] rounded-[2rem] border border-ink/8 bg-white">
              ...
              {/* Core node — Influencer Strategy & Discovery */}
        ...
        <div className="mt-12 lg:hidden">
          <div className="relative rounded-2xl border border-ink/8 bg-white p-5">
            <div className="mb-4 flex items-center justify-between font-mono text-[10px] font-bold uppercase tracking-[0.15em] text-ink/40">
              <span>Creator Growth System</span>
