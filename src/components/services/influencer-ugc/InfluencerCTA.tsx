...
export function InfluencerCTA() {
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="influencer-cta-heading">
            ...
            <div className="relative -m-6 overflow-hidden rounded-2xl sm:-m-8">
              ...
              <div className="relative z-10 p-8 text-center sm:p-16">
                <div className="inline-flex items-center gap-2 rounded-full border border-gold-400/40 bg-gold-50 px-4 py-1.5 text-xs font-black text-gold-700 shadow-2xs">
                  ...
                  <span>Let's Build Your Campaign</span>
                </div>

                <h2
                  id="influencer-cta-heading"
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                  ...
                  >
                    {influencerCta.primaryCta.label}
                  </Button>
                  <Button
                  ...
                  >
                    {influencerCta.secondaryCta.label}
                  </Button>
                </div>
              </div>
