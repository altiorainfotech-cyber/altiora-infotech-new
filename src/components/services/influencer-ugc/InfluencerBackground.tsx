...
export default function InfluencerBackground() {
  ...
  useEffect(() => {
    ...
    // Ecosystem group: a creator network — nodes representing connected voices/audiences
    ...
    // Creator nodes with connecting edges — voices amplifying a shared brand story
