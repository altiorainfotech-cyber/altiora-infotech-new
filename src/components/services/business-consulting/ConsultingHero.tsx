...
import { ConsultingHeroVisualClient } from "./ConsultingHeroVisualClient";
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          <div className="order-2 lg:order-1 lg:col-span-7">
            ...
            <Reveal delay={0.08}>
              <h1 className="mt-5 text-[clamp(2.1rem,4.4vw,3.5rem)] font-black leading-[1.1] tracking-tight text-ink text-balance">
            ...
            <Reveal delay={0.26}>
              <div className="mt-8">
                <Button href={businessConsultingHero.cta.href} className="px-7 py-3.5 text-sm font-bold shadow-lg shadow-blue-600/20">
                  {businessConsultingHero.cta.label}
                </Button>
              </div>
            </Reveal>
          </div>
