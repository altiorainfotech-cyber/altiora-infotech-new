...
export function ConsultingCTA() {
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="consulting-cta-heading">
            ...
            <div className="relative -m-6 overflow-hidden rounded-2xl sm:-m-8">
              ...
              <div className="relative z-10 p-8 text-center sm:p-16">
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                  ...
                  >
                    {businessConsultingCta.primaryCta.label}
                  </Button>
                  <Button
                  ...
                  >
                    {businessConsultingCta.secondaryCta.label}
                  </Button>
                </div>
              </div>
