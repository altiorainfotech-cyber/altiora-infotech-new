...
import { ConsultingCoverageGrid } from "./ConsultingCoverageGrid";

const overviewImage =
  "https://images.unsplash.com/photo-1758873268998-2f77c2d38862?auto=format&fit=crop&w=1200&h=900&q=80";
              ...
              <div className="mt-6 relative overflow-hidden rounded-2xl border border-ink/8 shadow-lg">
                <div className="relative aspect-[16/10] w-full">
                  ...
                  <div className="absolute bottom-3 left-3 flex items-center gap-2 rounded-lg border border-ink/10 bg-white/90 px-3 py-1.5 text-xs font-bold text-ink shadow-sm backdrop-blur-md">
                    ...
                    <span>From Strategy to Measurable Action</span>
                  </div>
                </div>
              </div>
            </Reveal>
          ...
          <div className="lg:col-span-7">
            <Reveal delay={0.08}>
              <span className="text-xs font-black uppercase tracking-wider text-blue-800">
                {businessConsultingOverview.coverHeading}
              </span>
            </Reveal>

            <div className="mt-4">
              <ConsultingCoverageGrid />
            </div>
          </div>
        </div>
      </Container>
