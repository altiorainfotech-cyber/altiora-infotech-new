...
export default function VideoProductionHeroVisual() {
  ...
  useEffect(() => {
    ...
    const coreGeo = new THREE.CylinderGeometry(0.5, 0.5, 0.5, 32);
    ...
    // Frame-chip nodes orbiting the lens with connecting lines
    const nodeGeo = new THREE.BoxGeometry(0.32, 0.18, 0.03);
