...
import { whyChooseVideoProduction } from "@/data/videoProduction";
import { ShieldCheck } from "lucide-react";

export function VideoProductionWhyChoose() {
  return (
    <section className="relative overflow-hidden bg-transparent py-14 sm:py-20" aria-labelledby="video-why-choose-heading">
      ...
      <Container>
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.05}>
            <h2 id="video-why-choose-heading" className="mt-3 text-3xl font-black tracking-tight text-ink sm:text-4xl">
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-12 gap-y-8 sm:grid-cols-2">
          {whyChooseVideoProduction.map((point, idx) => {
