...
export default function VideoProductionBackground() {
  ...
  useEffect(() => {
    ...
    // Ecosystem group: floating "film frame" panels representing footage/cuts
    ...
    // Floating flat "frame" panels — 16:9 aspect chips
    const nodeGeo = new THREE.BoxGeometry(0.36, 0.2, 0.03);
