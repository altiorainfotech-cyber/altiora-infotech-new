...
import { videoProductionCta } from "@/data/videoProduction";

export function VideoProductionCTA() {
  return (
    <section className="relative overflow-hidden py-16 sm:py-24" aria-labelledby="video-cta-heading">
      <Container>
        <div className="relative rounded-3xl border border-blue-500/20 bg-gradient-to-br from-slate-900 via-blue-950 to-ink p-8 sm:p-14 text-white shadow-2xl overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <Reveal delay={0.05}>
              <h2 id="video-cta-heading" className="mt-4 text-3xl sm:text-5xl font-black tracking-tight text-white leading-tight">
                {videoProductionCta.heading}
              </h2>
            </Reveal>

            <Reveal delay={0.1}>
              <p className="mt-4 text-base sm:text-lg text-white/80 font-medium leading-relaxed max-w-2xl">
                {videoProductionCta.description}
              </p>
            </Reveal>
            ...
            <Reveal delay={0.15}>
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <Link
                  href={videoProductionCta.primaryCta.href}
                ...
                >
                  <span>{videoProductionCta.primaryCta.label}</span>
                  <ArrowRight className="h-4 w-4" />
                </Link>

                <Link
                  href={videoProductionCta.secondaryCta.href}
                ...
                >
                  <span>{videoProductionCta.secondaryCta.label}</span>
                </Link>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="mt-8 pt-6 border-t border-white/10 flex items-center gap-3 text-xs font-mono font-bold text-white/70">
                ...
                <span>FULL-SERVICE 4K/8K CINEMATIC PRODUCTION SUITE</span>
              </div>
            </Reveal>
          </div>
        </div>
