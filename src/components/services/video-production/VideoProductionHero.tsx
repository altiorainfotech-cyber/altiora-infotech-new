...
import { ArrowRight, Clapperboard, Film, Target, Activity } from "lucide-react";
import { Container } from "@/components/ui/Container";
import { Reveal } from "@/components/ui/Reveal";
import { videoProductionHero } from "@/data/videoProduction";
import { VideoProductionHeroVisual } from "./VideoProductionHeroVisual";
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 space-y-6 text-left">
            ...
            <Reveal delay={0.15}>
              <div className="pt-2 flex flex-wrap items-center gap-4">
                <Link
                  href={videoProductionHero.cta.href}
                ...
                >
                  <span>{videoProductionHero.cta.label}</span>
                ...
                <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl border border-ink/8 bg-white/80 shadow-sm backdrop-blur-md">
                  <Film className="h-4 w-4 text-blue-500 animate-pulse" />
                  <span className="text-xs font-mono font-bold text-ink/80">4K & 8K Cinema Quality</span>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="pt-6 grid grid-cols-3 gap-4 border-t border-ink/8">
                <div>
                  ...
                  <div className="text-xs font-medium text-muted">Films Produced</div>
                </div>
                <div>
                  <div className="text-2xl font-black text-gold-600">100%</div>
                  <div className="text-xs font-medium text-muted">Original Score & Cut</div>
                </div>
                <div>
                  <div className="text-2xl font-black text-ink">50M+</div>
                  <div className="text-xs font-medium text-muted">Video Views</div>
                </div>
              </div>
            </Reveal>
          </div>
            ...
            <div className="relative mx-auto max-w-[480px] rounded-3xl border border-blue-200/60 bg-gradient-to-b from-white via-blue-50/40 to-slate-50 p-4 shadow-2xl backdrop-blur-xl">
              ...
              <div className="mt-3 flex items-center justify-between border-t border-blue-100 pt-3 px-2 text-[11px] font-mono font-bold text-blue-900">
                <span className="flex items-center gap-1">
                  <Clapperboard className="h-3.5 w-3.5 text-blue-600" />
                  <span>4K CINEMATIC SUITE</span>
                </span>
                <span className="text-gold-600">PRODUCTION READY</span>
              </div>
            </div>
          </div>
        </div>
